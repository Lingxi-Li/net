    ...
    SECTION("len 2") {
        ...
        SECTION("data 0xa55a") {
            ...
            SECTION("hishf 0, loshf 0") {
                ...
                REQUIRE(uint_const_view<len>{view} == 0x5aa5);
            }
    ...
    SECTION("len 1") {
        ...
        SECTION("0xa5") {
            ...
            SECTION("hishf 0, loshf 0") {
                ...
                view = 0x5a;
                REQUIRE(data == 0x5a);
                REQUIRE(uint_const_view<len>{view} == 0x5a);
            }
...
TEST_CASE("flags_view") {
    SECTION("len 8, hishf 0, loshf 0, mask 0x8000000000000001") {
        ...
        REQUIRE(flags_const_view<len, 0, 0, 0x8000000000000001>{flags} == 1);
    }
    ...
    SECTION("len 1, hishf 0, loshf 0, mask 0x55") {
        ...
        flags = 0x41;
        REQUIRE(byte == 0xeb);
        REQUIRE(flags_const_view<len, 0, 0, 0x55>{flags} == 0x41);
    }
}
